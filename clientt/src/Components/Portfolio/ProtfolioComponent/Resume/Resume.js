...
const Resume = (props) => {
  ...
  return (
    <>
      ...
      {console.log(user.experienceInfo)}
          ...
          <div className='content-section  mtop '>
              ...
              <div className='content'>
                {user.education?.map((val, id) => {
                    return <Card key={id}  header = "Education" college={val.collegeName}  title={val.DegreeName} CGPA={val.Percentage} City={val.City} state={val.State} Location={val.Location} />
            ...
            <div className='content-section mtop '>
              ...
              <div className=''>
                {user.experienceInfo?.map((val, id) => {
                      return <Card key={id} header = "Experience" companyName={val.companyName}  desgination={val.desgination} description={val.description} workDuration={val.workDuration} state={val.state}  />
