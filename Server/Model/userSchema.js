...
userSchema.methods.addpersonalInfo = async function (input1,input2,input3,input4,input5) {
    try {
        this.personalInfo = this.personalInfo.concat({ firstName: input1, lastName: input2, description: input3, Email: input4, phone: input5 });
